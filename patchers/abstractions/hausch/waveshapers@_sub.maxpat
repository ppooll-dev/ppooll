...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.25, 442.0, 47.0, 22.0 ],
					"text" : "pack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 58.25, 483.0, 41.0, 22.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 86.25, 353.0, 47.0, 22.0 ],
					"text" : "zl nth 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 86.25, 301.0, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 729.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 478.0, 76.0, 22.0 ],
									"text" : "prepend p24"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.0, 478.0, 76.0, 22.0 ],
									"text" : "prepend p23"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 134.0, 478.0, 76.0, 22.0 ],
									"text" : "prepend p22"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 478.0, 76.0, 22.0 ],
									"text" : "prepend p21"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 58.25, 395.0, 63.0, 22.0 ],
					"text" : "ll.p drywet"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.25, 623.0, 82.0, 22.0 ],
					"text" : "1 0 $1, 0 0 $2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 58.25, 524.0, 29.5, 22.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.25, 582.0, 47.0, 22.0 ],
					"text" : "pack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 86.25, 554.0, 29.5, 22.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 151.0, 674.685397386550903, 141.0, 22.0 ],
