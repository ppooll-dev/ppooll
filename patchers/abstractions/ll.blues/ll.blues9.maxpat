...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 131.0, 64.0, 22.0 ],
					"text" : "n p_status"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.0, 206.0, 24.0, 24.0 ]
				}
...
, 											{
												"box" : 												{
													...
													"text" : "routepass wsize bang getllblueargs chans channels status outputs~ outputsMix~ levels extra patcherargs"
												}
