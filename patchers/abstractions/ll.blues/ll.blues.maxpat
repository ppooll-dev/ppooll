...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 205.0, 59.0, 72.5, 21.0 ],
					"prefix" : "menu",
					"prefix_mode" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 233.25, 52.5, 66.0, 47.0 ],
									"text" : "bang after \nupdating\nll.blues.js"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 97.0, 18.0, 75.0, 20.0 ],
									"text" : "ll.blues inlet"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 290.75, 21.0, 36.0, 20.0 ],
									"text" : "GUIs"
								}
...
,
									"patching_rect" : [ 327.25, 58.0, 68.0, 22.0 ],
									"text" : "p loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 393.0, 318.5, 19.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 393.0, 290.5, 78.0, 22.0 ],
									"text" : "default pattrs"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.5, 90.0, 107.0, 20.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 13.0, 391.0, 29.5, 22.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 77.0, 345.0, 33.0, 22.0 ],
													"text" : "== 3"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 83.5, 473.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 83.5, 509.0, 61.0, 22.0 ],
													"text" : "hidden $1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 83.5, 538.0, 105.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 35.0, 345.0, 34.0, 22.0 ],
													"text" : "sel 3"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 84.0, 305.0, 39.0, 20.0 ],
													"text" : "meter"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 466.0, 157.0, 29.5, 22.0 ],
																	"text" : "$1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 466.0, 122.0, 75.0, 22.0 ],
																	"text" : "r #0chans"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 241.0, 137.0, 73.0, 22.0 ],
																	"text" : "r #0levels"
																}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 9.0, 304.0, 23.0, 22.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 35.0, 277.0, 75.0, 22.0 ],
													"text" : "r #0status"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 35.0, 304.0, 47.0, 22.0 ],
													"text" : "zl nth 4"
												}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 135.0, 74.0, 85.0, 20.0 ],
									"text" : "to patcherargs"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 135.0, 53.5, 21.0, 21.0 ]
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 146.923076923076906, 145.0, 147.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 120.0, 120.0, 70.0, 12.0 ],
...
,
									"patching_rect" : [ 327.25, 137.0, 87.0, 22.0 ],
									"text" : "p max_helper.."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 285.5, 58.0, 36.0, 36.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 327.25, 100.0, 96.0, 26.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 327.25, 18.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 361.25, 22.0, 58.0, 22.0 ],
									"text" : "r #0js"
								}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "bgcolors", 1 ], [ "c1", 0.024, 0.024, 0.6, 1 ], [ "c10", 0, 0, 0, 1 ], [ "c11", 0, 0, 0, 1 ], [ "c12", 0, 0, 0, 1 ], [ "c2", 0.1, 0.7, 0.5, 1 ], [ "c3", 0.2, 0.1, 0.3, 1 ], [ "c4", 0.635735544217687, 0.07530824829932, 0.691698554421769, 1 ], [ "c5", 0, 0, 0, 1 ], [ "c6", 0, 0, 0, 1 ], [ "c7", 0, 0, 0, 1 ], [ "c8", 0, 0, 0, 1 ], [ "c9", 0, 0, 0, 1 ], [ "colwidths", 73.333333333333329, 73.333333333333329 ], [ "enum_offset", 1 ], [ "fontsize", 11 ], [ "gridcolor", 0, 0, 0, 1 ], [ "header", 0 ], [ "header_text", "~", "ho_st1", "out.1" ], [ "headercolors", 3, 1, 1 ], [ "ignore_headerclick", 1 ], [ "modes", "menu_outputs_0", "menu_outputs_1" ], [ "multinumber", 0 ], [ "oncolors", 2 ], [ "param_offset", 0 ], [ "params", "outputsMix~", "outputsMix~" ], [ "rowheight_fixed", 1 ], [ "rows", 2 ], [ "size_lists", "_" ], [ "top_patcher", 0 ], [ "width_abs", 1 ] ],
