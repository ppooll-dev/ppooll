...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 77.0, 70.0, 22.0 ],
					"text" : "loadmess _"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.592156862745098, 0.105882352941176, 0.454901960784314, 1.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 497.0, 157.0, 78.0, 22.0 ],
									"text" : "color 00a001"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 460.0, 46.0, 100.0, 22.0 ],
									"text" : "color \"23 67 129\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 456.0, 113.0, 45.0, 22.0 ],
									"text" : "color 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 399.0, 122.0, 45.0, 22.0 ],
									"text" : "color 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 407.0, 213.0, 85.0, 22.0 ],
									"text" : "hexToRgb abc"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 406.0, 147.0, 57.0, 22.0 ],
									"text" : "color #2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 319.0, 33.0, 86.0, 22.0 ],
									"text" : "textsize ooooo"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 294.0, 80.0, 127.0, 22.0 ],
									"text" : "textsize #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 294.0, 242.0, 35.0, 22.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 181.0, 234.0, 27.0, 14.0 ],
									"textfile" : 									{
										"text" : "\n\n\nvar size, txtsize;\nsketch.default2d();\nvar act_color\n\n\nfunction textsize(v) {\n\twith (sketch) {\n\t\tfontsize(12);\n\t\tfont(\"Geneva\");\n\t\tsize = gettextinfo(v.toString());\n\t\ttxtsize = size[0]+20;\n\t\tpost(\"textsize: \",txtsize,\"\\n\");\n\t}\n}\n\nfunction color(col){\n\tpost((col.split(\" \").length), col, typeof col,col.split(\" \"),\"\\n\");\n\tif (col==0) act_color = -1;\n\telse if (col==1) act_color = [255, 255, 255];\n\telse if (col.split(\" \").length==3) act_color = col.split(\" \");\n\telse {\n\t\tvar shorthandRegex = /^#?([a-f\\d])([a-f\\d])([a-f\\d])$/i;\n  \t\tcol = col.replace(shorthandRegex, function(m, r, g, b) {\n    \treturn r + r + g + g + b + b;\n  \t\t});\n  \t\tvar result = /^#?([a-f\\d]{2})([a-f\\d]{2})([a-f\\d]{2})$/i.exec(col);\n    \tr = parseInt(result[1], 16);\n    \tg = parseInt(result[2], 16);\n    \tb = parseInt(result[3], 16);\n\t\tact_color = [r,g, b];\n\t}\n\tpost(\"color: \",act_color,\"\\n\");\n}\n\n\n",
										"filename" : "none",
										"flags" : 0,
										"embed" : 1,
										"autowatch" : 1
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 173.0, 171.0, 50.0, 22.0 ],
													"text" : "12"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 26.0, 195.0, 50.0, 22.0 ],
													"text" : "32"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 81.0, 80.0, 127.0, 22.0 ],
													"text" : "textsize #1"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 81.0, 126.0, 65.0, 14.0 ]
												}
...
,
										"classnamespace" : "box",
										"rect" : [ 711.0, 62.0, 641.0, 804.0 ],
										"gridsize" : [ 15.0, 15.0 ],
										"globalpatchername" : "1068n[1][3][2][1][1][1][6][1][1][1][2][2][2][1][1][3][2][1][3][3][1][2][3]",
										"boxes" : [ 											{
												"box" : 												{
													"id" : "obj-4",
													"maxclass" : "number",
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 253.0, 802.0, 97.0, 22.0 ],
													"text" : "s #0actname"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 107.0, 778.0, 96.0, 22.0 ],
													"text" : "s #0instance"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 270.0, 57.0, 101.0, 35.0 ],
													"text" : "markerlist ho_st1 control@1 fmrm1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 172.0, 277.0, 80.0, 22.0 ],
													"text" : "routepass #1"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.0, 196.0, 87.0, 22.0 ],
									"saved_object_attributes" : 									{
										"filename" : "ll.makeact.js",
										"parameter_enable" : 0
									}
,
...
,
					"patching_rect" : [ 245.0, 8.0, 59.0, 24.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 360.0, 117.0, 200.0, 22.0 ],
					"restore" : [ "_" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
...
,
													"patching_rect" : [ 370.5, 380.517578000000015, 43.0, 22.0 ],
													"saved_object_attributes" : 													{
														"globalpatchername" : ""
													}
,
...
,
					"patching_rect" : [ 220.0, 145.0, 159.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 77.0, 102.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 178.0, 9.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 178.0, 43.0, 261.0, 21.0 ],
...
,
					"patching_rect" : [ 17.0, 208.0, 36.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 82.0, 91.0, 22.0 ],
					"text" : "route loadbang",
					"varname" : "inlet"
				}
...
,
					"patching_rect" : [ 89.0, 145.0, 117.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 251.0, 70.0, 38.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 305.0, 45.0, 120.0, 22.0 ],
									"text" : "r #0actname"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 251.0, 111.0, 131.0, 22.0 ],
...
,
					"patching_rect" : [ 58.0, 208.0, 68.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.0, 16.0, 125.0, 22.0 ],
									"text" : "r #0::actname"
								}
...
,
					"patching_rect" : [ 17.0, 184.0, 76.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 35.0, 136.0, 22.0 ],
									"text" : "uli1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 233.0, 166.0, 78.0, 22.0 ],
									"text" : "n #0sub"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 2.0, 75.0, 22.0 ],
									"text" : "r #0.act"
								}
...
,
					"patching_rect" : [ 89.0, 112.0, 64.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 77.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 98.5, 141.5, 229.5, 141.5 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
