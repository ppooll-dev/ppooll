...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 565.0, 346.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.333328247070312, 446.0, 596.0, 35.0 ],
					"text" : "new comb newex 116 350 120 196617 mc.combine~ 2, new si newex 116 310 120 196617 mc.sig~ 0 @chans $1, connect mes 0 si 0, connect si 0 comb 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.5, 92.0, 142.0, 22.0 ],
					"text" : "ho_st1~-no-"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 697.333328247070312, 211.0, 58.0, 22.0 ],
					"text" : "change 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 322.833328247070312, 66.0, 105.0, 22.0 ],
					"text" : "regexp (.+)\\\\.(\\\\d+)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 860.333328247070312, 261.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 860.333328247070312, 292.0, 59.0, 22.0 ],
					"text" : "s ll_audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.333328247070312, 381.0, 236.0, 22.0 ],
					"text" : "delete comb, delete si, connect in 0 send 0"
				}
