...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 221.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 37.0, 194.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 37.0, 247.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 37.0, 172.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "change 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 65.0, 283.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 37.0, 282.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 37.0, 150.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "> 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 37.0, 120.0, 103.0, 22.0 ],
					"style" : "",
					"text" : "llc.base #1 #2",
					"varname" : "llc.base"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 54.5, 331.0, 30.5, 331.0, 30.5, 110.0, 46.5, 110.0 ],
					"source" : [ "obj-48", 0 ]
				}
