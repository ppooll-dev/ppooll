...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 146.0, 160.0, 12.0 ],
					"varname" : "ll.inputmix",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 542.0, 179.0, 172.0, 22.0 ],
					"text" : "actmaker rez@ \"240 240 240\"",
					"varname" : "act"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 181.0, 248.0, 613.0, 35.0 ],
									"text" : "492.428925 0.149749 0.618468 580.910645 0.060183 0.61401 622.065918 0.022967 0.788626 801.598206 0.037227 0.348922 1359.795898 0.007474 0.238334 1645.63 0.154536 0.07241 1882.007568 0.02423 0.766691"
								}
...
,
									"patching_rect" : [ 130.0, 178.0, 82.0, 19.0 ],
...
, 															{
																"box" : 																{
																	...
																	"restore" : 																	{
																		"delaybox" : [ 92.842582702636719, 92.887489318847656, 91.186279296875, 95.713935852050781, 96.994552612304688, 99.048095703125, 91.39373779296875 ],
																		"frequbox" : [ 883.4541015625, 2469.020751953125, 3057.057373046875, 4996.7041015625, 8297.7958984375, 9333.591796875, 10025.3251953125 ],
																		"gainbox" : [ 0.693220257759094, 0.430329948663712, 0.224699467420578, 0.317233711481094, 0.088757887482643, 0.70318591594696, 0.233883634209633 ]
																	}
,
																	"text" : "autopattr",
																	"varname" : "u748016846"
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 266.0, 675.0, 100.0, 19.0 ],
...
, 																			{
																				"patchline" : 																				{
																					"destination" : [ "obj-3", 0 ],
																					"midpoints" : [ 49.166666666666671, 619.0, 200.0, 619.0 ],
																					"source" : [ "obj-1", 2 ]
																				}
...
, 																			{
																				"patchline" : 																				{
																					"destination" : [ "obj-1", 2 ],
																					"midpoints" : [ 197.5, 574.0, 49.166666666666671, 574.0 ],
																					"order" : 1,
																					"source" : [ "obj-7", 0 ]
																				}
...
, 															{
																"patchline" : 																{
																	...
																	"midpoints" : [ 531.5, 403.0, 376.699999999999989, 403.0 ],
																	"source" : [ "obj-4", 3 ]
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-15", 1 ],
																	"midpoints" : [ 501.5, 391.0, 356.100000000000023, 391.0 ],
																	"source" : [ "obj-4", 2 ]
																}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 60.0, 222.0, 111.0, 19.0 ],
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-4", 0 ],
													"midpoints" : [ 102.166666666666657, 100.0, 140.0, 100.0, 140.0, 35.0, 86.5, 35.0 ],
													"source" : [ "obj-5", 2 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.0, 148.0, 25.0, 25.0 ],
									"varname" : "in2[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 101.0, 258.0, 25.0, 25.0 ],
									"varname" : "out1[1]"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 542.0, 137.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"clearbutton" : [ -1 ],
						"gainslider" : [ 137.956207275390625 ],
						"master" : [ 0 ],
						"partialsbutton" : [ -1 ],
						"pres_menu" : [ "" ],
						"preset-ramp" : [ 0.0 ],
						...
						"tetris_menu" : [ "" ],
						"title_menu" : [ "subpatch" ],
						"transformslider" : [ 0.041458333333333, 0.443666666666667 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"jsarguments" : [ 15, "255 255 255", "50 50 50", "255 0 0", "0 255 0", "rez@1" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 555.0, 134.0, 100.0, 22.0 ],
					"restore" : [ "in(2)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"name" : "jb.delta.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/ppooll/patchers/abstractions/joseph branciforte",
				"patcherrelativepath" : "../abstractions/joseph branciforte",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
