...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 862.0, 1.0, 30.0, 17.0 ],
					"slidermax" : 50.0,
					"sliderstyle" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 788.0, 1.0, 34.0, 17.0 ],
					"slidermax" : 50.0,
					"sliderstyle" : 2,
					"textcolornofocus" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "range"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 722.0, 1.0, 18.0, 17.0 ],
					"text" : "r",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 822.0, 0.0, 31.0, 97.0 ],
					"rowheight" : 6,
					"rows" : 1,
					"varname" : "cb",
					"vscroll" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 740.0, 1.0, 48.0, 17.0 ],
					"slidermax" : 10000.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 823.0, 0.0, 19.0, 18.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"sliderstyle" : 2,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 226.0, 0.0, 42.0, 17.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"sliderstyle" : 2,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.0, 0.0, 28.0, 17.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"sliderstyle" : 2,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 371.0, 1.0, 23.0, 17.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"sliderstyle" : 2,
					"varname" : "oct_div"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 502.0, 1.0, 55.0, 17.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"sliderstyle" : 2,
					"varname" : "frequency"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 166.0, 0.0, 28.0, 17.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"sliderstyle" : 2,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 692.0, 1.0, 29.179199000000001, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 665.0, 1.0, 27.179199000000001, 17.0 ],
					"prototypename" : "M4L.toggle",
					"text" : "poly",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "poly",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 558.0, 1.0, 49.0, 17.0 ],
					"slidermax" : 0.9,
					"slidermin" : 0.2,
					"varname" : "vel2vol"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 269.0, 0.0, 47.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 442.0, 1.0, 59.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 136.0, -1.0, 31.0, 17.0 ],
					"text" : "stop",
					"varname" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"frequency" : [ 1127.049999999999955 ],
						"kb_size" : [ 1300.0 ],
						"keyboard" : [ -1 ],
						"keyslider_mode" : [ 1 ],
						"mapping" : [ 1 ],
						...
						"to_pp" : [ 0 ],
						"vel" : [ 0.0 ],
						"vel2vol" : [ 0.070000000298023, 0.17 ],
						"vel_factor" : [ 1.0 ],
						"voices" : [ 0.0 ]
					}
,
...
,
									"patching_rect" : [ 53.0, 25.0, 121.0, 22.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 270.0, 105.0, 19.0, 22.0 ],
													"text" : "n"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 169.0, 104.0, 83.0, 22.0 ],
													"text" : "ll.r am_poly_v"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 60.0, 70.0, 76.0, 35.0 ],
													"text" : "1127.050822",
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"id" : "obj-35",
													"items" : [ "no", ",", "2Dsliders1", ",", "control@1", ",", "control@2", ",", "control@3", ",", "control@4", ",", "ho_st1", ",", "mcpanner1", ",", "midikeys1", ",", "sinsE1" ],
													"maxclass" : "umenu",
													"numinlets" : 1,
													"numoutlets" : 3,
													"outlettype" : [ "int", "", "" ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 240.5, 192.5, 19.0, 129.0 ],
													"text" : "0 0."
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 362.0, 373.0, 92.0, 22.0 ],
													"text" : "s #0vel_on"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 418.0, 81.0, 156.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 390.0, 341.0, 100.0, 22.0 ],
													"text" : "s #0note_on"
												}
...
, 																			{
																				"box" : 																				{
																					...
																					"text" : "56 6 59 5 60 4 58 3 54 2 52 1"
																				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 410.0, 46.0, 58.0, 22.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 410.0, 121.0, 43.0, 22.0 ],
													"text" : "ll.pf cb"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 410.0, 80.0, 59.0, 22.0 ],
													"text" : "refer held"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 484.0, 355.0, 47.0, 22.0 ],
													"text" : "ll.r stop"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 495.0, 474.0, 32.0, 22.0 ],
													"text" : "$1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 484.0, 398.0, 71.0, 22.0 ],
													"text" : "dump, clear"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 484.0, 441.0, 53.0, 22.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0,
														"precision" : 6
													}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 573.0, 398.0, 35.0, 22.0 ],
													"text" : "clear"
												}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.0, -1.0, 53.0, 21.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "mapping"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 71.0, -2.0, 65.0, 21.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 371.0, -1.0, 70.0, 21.0 ],
					"pattrmode" : 1,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 608.0, 1.0, 60.64990234375, 20.2890625 ],
					"prototypename" : "M4L.toggle",
					"text" : "to_ppooll",
