...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.5, 18.0, 36.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.5, 0.0, 37.5, 16.0 ],
					"varname" : "presets"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 18.0, 49.0, 19.0 ],
					"text" : "norm W",
					"texton" : "norm W",
					"usebgoncolor" : 1,
					"varname" : "wNrm"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 18.0, 44.0, 19.0 ],
					"text" : "B to A",
					"texton" : "A to B",
					"usebgoncolor" : 1,
					"varname" : "abba"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 90.0, 16.0 ],
					"varname" : "title_LCD"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 391.0, 127.0, 207.0, 22.0 ],
					"text" : "actmaker spat.abba@ \"100 100 100\"",
					"varname" : "act"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 144.0, 272.0, 109.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 144.0, 234.0, 70.0, 22.0 ],
									"text" : "mc.pack~ 4"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 144.0, 129.0, 84.0, 22.0 ],
									"text" : "mc.unpack~ 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 144.0, 87.0, 51.0, 22.0 ],
									"text" : "ll.r~ in 4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 54.0, 306.5, 199.0, 33.0 ],
									"text" : "v1.1 . 2020/01/12\nclemens.hausch@moozak.org"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 146.0, 89.0, 22.0 ],
									"text" : "prepend wNrm"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 87.0, 85.0, 22.0 ],
									"text" : "prepend abba"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 44.0, 122.0, 60.0, 22.0 ],
									"text" : "ll.p wNrm"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 44.0, 63.0, 56.0, 22.0 ],
									"text" : "ll.p abba"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 48.0, 28.0, 377.0, 33.0 ],
...
, 											{
												"box" : 												{
													"code" : "atob(LF, RF, LB, RB){\r\n\tW = 0.5 * ((LF + LB) + (RF + RB));\r\n\tX = 0.5 * ((LF - LB) + (RF - RB));\r\n\tY = 0.5 * ((LF - RB) - (RF - LB));\r\n\tZ = 0.5 * ((LF - LB) + (RB - RF));\r\n\treturn W, X, Y, Z;\r\n}\r\n\r\nwnatob(LF, RF, LB, RB){\r\n\tW = (sqrt(3/8) * LF) + (sqrt(3/8) * RF) + (sqrt(3/8) * LB) + (sqrt(3/8) * RB);\r\n\tX = 0.5 * (LF + RF - LB - RB);\r\n\tY = 0.5 * (LF - RF + LB - RB);\r\n\tZ = 0.5 * (LF - RF - LB + RB);\r\n\treturn W, X, Y, Z;\r\n}\r\n\r\nbtoa(W, X, Y, Z){\r\n\tLF = 0.5 * (W + X + Y + Z);\r\n\tRF = 0.5 * (W + X - Y - Z);\r\n\tLB = 0.5 * (W - X + Y - Z);\r\n\tRB = 0.5 * (W - X - Y + Z);\r\n\treturn LF, RF, LB, RB;\r\n}\r\n\r\nwnbtoa(W, X, Y, Z){\r\n\tLF = (1/sqrt(6) * W) + (0.5 * X) + (0.5 * Y) + (0.5 * Z);\r\n\tRF = (1/sqrt(6) * W) + (0.5 * X) - (0.5 * Y) - (0.5 * Z);\r\n\tLB = (1/sqrt(6) * W) - (0.5 * X) + (0.5 * Y) - (0.5 * Z);\r\n\tRB = (1/sqrt(6) * W) - (0.5 * X) - (0.5 * Y) + (0.5 * Z);\r\n\treturn LF, RF, LB, RB;\r\n}\r\n\r\nParam abba(0);\r\nParam wNrm(0);\r\n\r\nif (abba == 1) {\r\n\tif (wNrm == 0) {\r\n\t\tout1, out2, out3, out4 = atob(in1, in2, in3, in4);\r\n\t} else {\r\n\t\tout1, out2, out3, out4 = wnatob(in1, in2, in3, in4);\r\n\t}\r\n} else {\r\n\tif (wNrm == 0) {\r\n\t\tout1, out2, out3, out4 = btoa(in1, in2, in3, in4);\r\n\t} else {\r\n\t\tout1, out2, out3, out4 = wnbtoa(in1, in2, in3, in4);\r\n\t}\r\n}",
													"fontface" : 0,
													"fontname" : "<Monospaced>",
													"fontsize" : 12.0,
													"id" : "obj-6",
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 48.0, 106.0, 646.0, 473.0 ]
												}
...
,
									"patching_rect" : [ 144.0, 180.0, 105.0, 22.0 ],
									"text" : "gen~ @title a to b"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 404.0, 82.0, 100.0, 22.0 ],
					"restore" : [ "in(4)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
