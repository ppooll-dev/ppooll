...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 60.0, 200.5, 16.0 ],
					"sliderlog" : 8.0,
					"slidermin" : 1.0,
					"varname" : "p1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 130.0, 201.0, 13.0 ],
					"varname" : "ll.inputmix",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 95.0, 200.5, 16.0 ],
					"slidermax" : 2.0,
					"slidermin" : -360.0,
					"varname" : "p22"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 78.0, 200.5, 16.0 ],
					"slidermax" : 12.0,
					"slidermin" : -96.0,
					"varname" : "p21"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 59.0, 200.5, 16.0 ],
					"sliderlog" : 8.0,
					"slidermax" : 1.0,
					"varname" : "p23"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 143.0, 201.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.737254901960784, 0.090196078431373, 0.03921568627451, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.0, 36.0, 169.5, 22.0 ],
					"varname" : "shapermode"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"ignoreclick" : 1,
					"items" : [ "as-mr_200116", ",", "ballon", ",", "bang", ",", "blindsee", ",", "versatz_191206", ",", "-", ",", "write", ",", "clear!", ",", "TEXT" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.628006000000028, 369.0, 85.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.628006000000028, 151.0, 77.0, 22.0 ],
									"text" : "loadmess 20"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 57.628006000000028, 181.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.628006000000028, 212.0, 83.0, 22.0 ],
									"text" : "prepend ramp"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "reset" ],
									"patching_rect" : [ 57.628006000000028, 304.0, 42.0, 22.0 ],
									"text" : "t reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.628006000000028, 273.0, 51.0, 22.0 ],
									"text" : "ll.r reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 406.0, 304.0, 49.0 ],
									"text" : "ll.pm ramp p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12p p13 p14 p15 p16p p17 p18 p19 p20 p21 p22 p23 p24 shapermode"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 234.128006000000028, 372.0, 123.0, 22.0 ],
...
,
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 163.128006000000028, 433.0, 55.0, 22.0 ],
									"text" : "mc.gen~",
									"wrapper_uniquekey" : "u313010955"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 213.128006000000028, 326.0, 22.0, 22.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 213.128006000000028, 286.0, 50.0, 22.0 ],
									"text" : "select 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 274.0, 170.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 212.0, 108.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 274.0, 135.0, 29.5, 22.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 213.128006000000028, 143.0, 40.0, 22.0 ],
									"text" : "t i b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 213.128006000000028, 106.0, 57.0, 22.0 ],
									"text" : "ll.p on/off"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 234.128006000000028, 243.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 274.0, 106.0, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 213.128006000000028, 72.0, 70.0, 22.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 163.0, 66.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 163.0, 495.0, 30.0, 30.0 ]
								}
