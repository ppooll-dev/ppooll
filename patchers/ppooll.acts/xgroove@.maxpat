...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-40",
					"items" : [ "Harvey Scales - Dancing room only [9_HrHbjG0GQ].webm.wav", ",", "onload2.wav" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
