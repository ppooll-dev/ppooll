...
, 			{
				"box" : 				{
					...
					"restore" : [ 1.0, 1.0, 0.357142857142857, 109.278372591006431, 1.0, 888.721627408993527, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"clear_env" : [ -1 ],
						"display_selected" : [ -1 ],
						"end" : [ 3120.872583958046107 ],
						"envelope_display" : [ 1000.0, 0.0, 1.0, 0.0, 0.0, 1, 1.0, 1.0, 0, 110.278372591006431, 0.357142857142857, 0, 999.0, 1.0, 0, 1000.0, 0.0, 1, "linear" ],
						"full_display" : [ -1 ],
						"full_env" : [ -1 ],
						"full_select" : [ -1 ],
						"interp" : [ 2 ],
						"keep_length" : [ 1 ],
						"length" : [ 3120.872583958046107 ],
						"loop_mode" : [ 1 ],
						"master" : [ 0 ],
						"play/stop" : [ 1 ],
						"pres_menu" : [ "_" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-25",
					"ignoreclick" : 1,
					"items" : [ "-", ",", "1440_presets", ",", "1440_presets.json", ",", "1440wide", ",", "1440wide.json", ",", "-", ",", "ƒ", "big.json", ",", "ƒ", "default.json" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 1, 1.0, 1.0, 0, 110.278372591006431, 0.357142857142857, 0, 999.0, 1.0, 0, 1000.0, 0.0, 1 ],
