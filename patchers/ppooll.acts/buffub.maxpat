...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-7",
					"items" : [ "no", ",", "buffer_host1", ",", "buffub1", ",", "ho_st1", ",", "noize@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 110.0, 366.0, 150.0, 22.0 ]
												}
