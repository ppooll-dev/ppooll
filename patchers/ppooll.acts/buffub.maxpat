...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 143.0, 35.0, 30.0, 16.0 ],
					"prototypename" : "blue",
					"rounded" : 1.0,
					"text" : "send",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 1.0, 30.0, 20.0 ],
					"text" : "pos",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 118.0, 52.0, 36.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 50.0, 35.0, 19.0 ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-7",
					"items" : [ "no", ",", "buffer_host1", ",", "buffub1", ",", "fffb@1", ",", "ho_st1", ",", "modul.ator1", ",", "modul.ator2", ",", "notepad@1", ",", "overdrive@1", ",", "prdelay@1", ",", "snap@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 35.0, 35.0, 19.0 ],
					"pattrmode" : 1,
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "ps_act"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 151.0, 1.0, 57.0, 19.0 ],
					"pattrmode" : 1,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "pos_act"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"append-switch" : [ 0 ],
						"buffer" : [ "3dem.aif" ],
						"end" : [ 1611.8900146484375 ],
						"full_select" : [ -1 ],
						"gain" : [ 109 ],
						"length" : [ 635.46002197265625 ],
						"link-switch" : [ 0 ],
						"loop-switch" : [ 1 ],
						"master" : [ 0 ],
						"mix-level" : [ 1.0 ],
						...
						"pos_par" : [ "-no-" ],
						"pos_send_now" : [ -1 ],
						"position" : [ 976.42999267578125 ],
						"pres_menu" : [ "_" ],
						"ps_act" : [ "no" ],
						"ps_par" : [ "-no-" ],
						"rec-switch" : [ 0 ],
						"start" : [ 976.42999267578125 ],
						"tetris_menu" : [ "" ],
						"title_menu" : [ "subpatch" ],
						"zoom_in" : [ -1 ],
						"zoom_out" : [ -1 ]
