...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 56.5, 0.0, 77.5, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-7",
					"items" : [ "no", ",", "Benjolino1", ",", "bandfollower1", ",", "banger1", ",", "beauty1", ",", "buffer_host1", ",", "buffub1", ",", "control@1", ",", "control@2", ",", "distort@1", ",", "ho_st1", ",", "matriarch@1", ",", "miClouds1", ",", "modul.ator1", ",", "modul.ator2", ",", "modul.ator3", ",", "modul.ator4", ",", "modul.ator5", ",", "pr.spectdelay1", ",", "romb1", ",", "vp.sourcefilter1", ",", "xgroove@1", ",", "xgroove@2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 247.0, 35.0, 22.0 ],
									"text" : "137 ."
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 456.0, 62.0, 33.0, 22.0 ],
													"text" : "== 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 456.0, 95.0, 61.0, 22.0 ],
													"text" : "hidden $1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 456.0, 128.0, 91.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 311.0, 20.0, 24.0, 24.0 ]
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 230.0, 448.0, 43.0, 22.0 ],
													"text" : "ll.pf wf"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 126.0, 457.0, 44.0, 22.0 ],
													"text" : "line $1"
												}
