...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 60.0, 0.0, 25.0, 15.0 ],
					"prototypename" : "blue",
					"rounded" : 1.0,
					"text" : "adc",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 132.0, 0.0, 51.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 84.0, 0.0, 51.0, 19.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "multichannelsignal" ],
													"patching_rect" : [ 96.5, 333.0, 60.0, 22.0 ],
													"text" : "mc.pack~"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 96.5, 302.0, 60.0, 19.0 ],
													"text" : "adc~ 1 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "multichannelsignal" ],
													"patching_rect" : [ 69.5, 364.0, 46.0, 19.0 ],
													"text" : "mc.gate~"
												}
...
,
									"patching_rect" : [ 344.0, 239.0, 75.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
