...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-7",
					"items" : [ "no", ",", "buffer_host1", ",", "buffub1", ",", "ho_st1", ",", "tetris@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 															{
																"box" : 																{
																	...
																	"text" : ";\rINmulti1 outputs~ buffub1~in.1 _"
																}
