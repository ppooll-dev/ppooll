...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-7",
					"items" : [ "no", ",", "buffer_host1", ",", "buffub1", ",", "flop1", ",", "ho_st1", ",", "mmods@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
