...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"append-switch" : [ 0 ],
						"buffer" : [ "sb1_1886_1" ],
						"end" : [ 570.9000244140625 ],
						"full_select" : [ -1 ],
						"gain" : [ 137 ],
						"length" : [ 305.84002685546875 ],
						"link-switch" : [ 1 ],
						"loop-switch" : [ 1 ],
						"master" : [ 0 ],
						"mix-level" : [ 0.444444444444444 ],
						"mix-switch" : [ 1 ],
						"pos_act" : [ "no" ],
						"pos_par" : [ "-no-" ],
						"pos_send_now" : [ -1 ],
						"position" : [ 265.05999755859375 ],
						"pres_menu" : [ "_" ],
						"ps_act" : [ "no" ],
						"ps_par" : [ "-no-" ],
						"rec-switch" : [ 0 ],
						"start" : [ 265.05999755859375 ],
						"tetris_menu" : [ "" ],
						"title_menu" : [ "info" ],
						"zoom_in" : [ -1 ],
						"zoom_out" : [ -1 ]
