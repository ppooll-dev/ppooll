...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"ignoreclick" : 1,
					"items" : [ "density", ",", "-", ",", "write", ",", "clear!", ",", "TEXT", ",", "_" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 103.0, 193.0, 35.0, 22.0 ],
									"text" : "reset"
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 2,
													"numoutlets" : 0,
													"patching_rect" : [ 131.0, 81.0, 89.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 49.0, 51.0, 85.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 222.0, 158.0, 66.0, 22.0 ],
									"text" : "ll.r in_mix~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 222.0, 259.0, 68.0, 22.0 ],
									"text" : "ll.pf ll.blues"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 298.0, 158.0, 85.0, 22.0 ],
									"text" : "ll.r llbluechans"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 103.0, 170.0, 100.0, 22.0 ],
									"text" : "meter #0meter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 103.0, 108.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 103.0, 150.0, 96.0, 22.0 ],
									"text" : "gains #0gains"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 397.0, 158.0, 150.0, 22.0 ]
								}
