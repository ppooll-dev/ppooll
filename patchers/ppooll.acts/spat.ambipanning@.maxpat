...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 813.0, 350.0, 75.0, 21.0 ],
					"restore" : [ "in(12)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 801.0, 208.0, 202.0, 21.0 ],
					"text" : "actmaker spat.ambipanning@ 8888bb",
					"varname" : "act"
				}
