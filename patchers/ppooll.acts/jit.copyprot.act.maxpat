...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.75, 33.0, 25.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 68.5, 16.0, 32.0, 26.0 ],
					"slidercolor" : [ 0.0, 0.0, 0.0, 0.0 ],
					"slidercolornofocus" : [ 0.478431, 0.478431, 0.478431, 0.0 ],
					"varname" : "dimxy"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 43.5, 33.0, 18.0, 16.0 ],
					"rounded" : 1.0,
					"text" : "v",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 43.5, 16.0, 26.0, 19.0 ],
					"pattrmode" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 164.0, 332.0, 49.0, 20.0 ],
									"text" : "ll.pf fps"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 77.0, 171.0, 73.0, 20.0 ],
									"text" : "pak dim 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 104.0, 140.0, 61.0, 20.0 ],
									"text" : "ll.p dimxy"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 273.0, 212.0, 78.0, 20.0 ],
									"text" : "prepend rect"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 273.0, 185.5, 41.0, 20.0 ],
									"text" : "zl join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 295.0, 146.0, 82.0, 20.0 ],
									"text" : "vexpr $i1+$i2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 273.0, 103.5, 57.0, 20.0 ],
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 273.0, 69.5, 46.0, 20.0 ],
									"text" : "ll.r rect"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.0, 105.0, 64.0, 17.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.0, 84.0, 37.0, 17.0 ],
									"text" : "ll.r dim"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 162.0, 213.0, 46.0, 17.0 ],
									"text" : "ll.jact"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 273.0, 312.0, 30.0, 17.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 162.0, 284.0, 130.0, 17.0 ],
