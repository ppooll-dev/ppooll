...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 0.0, 108.0, 16.0 ],
					"varname" : "title_LCD"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 117.0, 137.0, 19.0 ],
					"text" : "actmaker jit.copyprot.act \"0 0 0\"",
					"varname" : "act"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 75.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.5, 0.0, 56.5, 20.0 ],
					"pattrmode" : 1,
					"textcolor" : [ 0.149, 0.149, 0.149, 1.0 ],
					"varname" : "title_menu"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1.0, 0.0, 56.5, 14.0 ],
					"varname" : "master"
				}
