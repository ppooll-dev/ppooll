...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 265.0, 126.0, 65.0, 22.0 ],
									"text" : "ll.r~ right 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "v3.1 - 2022/01/23 - hausch@moozak.org"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 430.0, 126.0, 89.0, 22.0 ],
									"text" : "ll.r right @mc 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 215.0, 171.0, 581.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 175.0, 306.0, 266.0, 22.0 ],
									"text" : "mc.gen~ @gen op@_200530.gendsp @chans 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 197.333333333333314, 126.0, 58.0, 22.0 ],
									"text" : "ll.r~ left 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 339.666666666666629, 126.0, 82.0, 22.0 ],
									"text" : "ll.r left @mc 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 234.0, 50.0, 22.0 ],
									"text" : "reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 310.0, 150.0, 22.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 206.833333333333314, 192.5, 184.5, 192.5 ],
									"source" : [ "obj-135", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 3 ],
									"midpoints" : [ 439.5, 226.5, 431.5, 226.5 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 274.5, 226.5, 266.833333333333314, 226.5 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 32.5, 281.0, 184.5, 281.0 ],
									"source" : [ "obj-56", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"id" : "obj-33",
					"items" : [ "no", ",", "def_outputs1", ",", "fmrm1", ",", "ho_st1", ",", "noize@1", ",", "op@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-72",
					"items" : [ "-no-", ",", "in.0", ",", "in.1", ",", "in.2", ",", "in.3", ",", "in.4", ",", "in.5", ",", "in.6", ",", "freq.0", ",", "freq.1", ",", "freq.2", ",", "freq.3", ",", "freq.4", ",", "freq.5", ",", "freq.6", ",", "res.0", ",", "res.1", ",", "res.2", ",", "res.3", ",", "res.4", ",", "res.5", ",", "res.6" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
