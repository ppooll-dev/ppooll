        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 96.0, 92.0, 30.0, 13.0 ],
                    "pattrmode": 1,
                    "prefix": "",
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 65.0, 92.0, 30.0, 13.0 ],
                    "pattrmode": 1,
                    "prefix": "",
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "fontname": "Arial",
                    "id": "obj-38",
                    "items": [ "off", ",", "a(left)", ",", "b(right)", ",", "a", "+", "b", ",", "a", "-", "b", ",", "a", "*", "b", ",", "a", "/", "b", ",", "a", "%", "b", ",", "absdiff(a, b)", ",", "minimum(a, b)", ",", "maximum(a, b)", ",", "(a+b)/2", ",", "and(a, b)", ",", "or(a, b)", ",", "xor(a, b)", ",", "not(a, b)", ",", "a", "==", "b", ",", "a", "==p", "b", ",", "a", ">", "b", ",", "a", ">=", "b", ",", "a", ">p", "b", ",", "a", ">=p", "b", ",", "a", "<", "b", ",", "a", "<=", "b", ",", "a", "<p", "b", ",", "a", "<=p", "b", ",", "sah(a, b, 0.5)", ",", "pow(a, b)", ",", "pow(a, 1 / b)", ",", "log(a) / log(b)", ",", "sin(a) * b", ",", "cos(a) * b", ",", "sin(a + b)", ",", "cos(a + b)", ",", "sin(a * b)", ",", "cos(a * b)" ],
                    "maxclass": "ll_menu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 128.0, 92.0, 25.0, 13.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 1.0, 92.0, 62.0, 13.0 ],
                    "presentation": 1,
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "", "" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 26.666666666666668, 0.0, 119.99999999999999, 26.0 ],
                                    "textfile": {
                                        "filename": "ll.listblock.js",
                                        "flags": 0,
                                        "embed": 0,
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "hidden": 1,
                                    "id": "obj-19",
                                    "items": [ "no", ",", "ho_st1", ",", "noize@1", ",", "noize@2", ",", "op@1", ",", "op@2" ],
                                    "maxclass": "ll_menu",
                                    "numinlets": 1,
                                    "numoutlets": 3,
                                    "outlettype": [ "", "", "" ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "v4.2 - 2025/10/28 - hausch@moozak.org"
                                }
                            },
                            {
                                "box": {
