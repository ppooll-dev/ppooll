...
,
		"classnamespace" : "box",
		"rect" : [ 642.0, 252.0, 186.0, 153.0 ],
		"gridsize" : [ 15.0, 15.0 ],
		"toolbarvisible" : 0,
		"globalpatchername" : "demosound@1",
		"boxes" : [ 			{
				"box" : 				{
					"hidden" : 1,
					"id" : "obj-7",
					...
					"patching_rect" : [ 193.0, 117.0, 88.0, 22.0 ],
					"text" : "mc.dup~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 100.0, 186.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "demosound@bp.maxpat",
					"numinlets" : 0,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -5.5, 10.0, 191.0, 91.0 ],
					"viewvisibility" : 1
				}
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 62.0, 100.0, 22.0 ],
					"priority" : 					{
						"title_menu" : 2010,
						"pres_menu" : 2011,
						"tetris_menu" : 2012,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 311.0, 104.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.0, 125.0, 107.0, 22.0 ],
					"text" : "pattrmarker no",
					"varname" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 311.0, 146.0, 107.0, 22.0 ],
...
,
					"patching_rect" : [ 311.0, 233.0, 120.0, 22.0 ],
					"text" : "p demosound@_sub",
					"varname" : "sub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 99.224609375, 16.0 ],
					"varname" : "act",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 83.0, 115.0, 22.0 ],
...
,
		...
		"bgcolor" : [ 0.6, 0.8, 0.666666666666667, 1.0 ]
	}
