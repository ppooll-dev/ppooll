...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 163.0, 160.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 152.0, 160.0, 12.0 ],
					"varname" : "ll.inputmix",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 157.5, 199.0, 39.5, 18.0 ],
					"prototypename" : "jit_on",
					"text" : "filter",
					"textcolor" : [ 0.752941, 0.023529, 0.247059, 1.0 ],
					"texton" : "vocoder",
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 207.0, 153.0, 30.0, 18.0 ],
					"prototypename" : "jit_on",
					"text" : "fade",
					"textcolor" : [ 0.752941, 0.023529, 0.247059, 1.0 ],
					"texton" : "fade",
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 187.0, 153.0, 23.0, 18.0 ],
					"prototypename" : "jit_on",
					"text" : "reset",
					"textcolor" : [ 0.752941, 0.023529, 0.247059, 1.0 ],
					"texton" : "peak",
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 157.0, 153.0, 32.0, 18.0 ],
					"prototypename" : "jit_on",
					"text" : "peak",
					"textcolor" : [ 0.752941, 0.023529, 0.247059, 1.0 ],
					"texton" : "peak",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 199.0, 142.0, 19.0 ],
					"text" : "actmaker forbiddenP \"159 11 68\"",
					"varname" : "act"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 152.0, 30.0, 19.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
					"triscale" : 0.9,
					"varname" : "redraw/fade"
...
, 			{
				"box" : 				{
					"annotation" : "noise-level",
					"bgcolor" : [ 1.0, 0.768627, 0.478431, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 9.0,
					"htricolor" : [ 0.87, 0.82, 0.24, 1.0 ],
					"id" : "obj-12",
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 168.0, 30.0, 19.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
					"triscale" : 0.9,
					"varname" : "noise-level"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 159.0, 171.0, 78.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 184.0, 16.0, 19.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 184.0, 16.0, 19.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.0, 26.0, 14.0, 127.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 50.0 ],
					"slidercolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 245.0, 306.0, 80.0, 13.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 275.0, 177.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 248.0, 134.0, 27.0, 17.0 ],
													"text" : "gate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 222.0, 58.0, 32.5, 17.0 ],
													"text" : "!- 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 95.0, 93.0, 27.0, 17.0 ],
													"text" : "gate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 183.0, 57.0, 31.0, 17.0 ],
													"text" : "sel 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 110.0, 70.0, 27.0, 17.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 110.0, 39.0, 50.0, 17.0 ],
													"text" : "ll.p mode!"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 307.0, 295.0, 60.0, 17.0 ],
													"text" : "t peakreset"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 197.0, 86.0, 72.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 183.0, 31.0, 68.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 214.0, 273.0, 70.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 307.0, 274.0, 64.0, 17.0 ],
													"text" : "ll.p peakreset"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 214.0, 295.0, 62.0, 15.0 ],
													"text" : "peakhold $1"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 158.0, 109.0, 35.0, 17.0 ],
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
													"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
													"triscale" : 0.9
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 211.0, 190.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 124.0, 319.0, 68.0, 17.0 ],
													"text" : "ll.pf multislider"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 110.0, 134.0, 62.0, 17.0 ],
													"text" : "qmetro 100"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 148.0, 256.0, 40.0, 17.0 ],
													"text" : "* 127."
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 110.0, 157.0, 53.0, 17.0 ],
													"text" : "t 1 b b 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 162.0, 203.0, 27.0, 17.0 ],
													"text" : "- 1"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 130.0, 183.0, 43.0, 17.0 ],
													"text" : "Uzi 256"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 124.0, 284.0, 65.0, 17.0 ],
													"text" : "zl group 256"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 162.0, 227.0, 70.0, 17.0 ],
													"text" : "peek~ EqFun~"
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 0.0, 50.0, 52.0, 17.0 ],
													"text" : "* 0.0111"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 0.0, 72.0, 27.0, 17.0 ],
													"text" : "t b f"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 2.0, 27.0, 66.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 73.0, 103.0, 27.0, 17.0 ],
													"text" : "* 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 94.0, 133.0, 30.0, 17.0 ],
													"text" : "0. 0."
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 96.0, 65.0, 27.0, 17.0 ],
													"text" : "t f f"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 113.0, 109.0, 27.0, 17.0 ],
													"text" : "+ 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 113.0, 86.0, 33.0, 17.0 ],
													"text" : "* -1."
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 190.0, 32.0, 35.0, 17.0 ],
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
													"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
													"triscale" : 0.9
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 350.0, 192.0, 40.0, 17.0 ],
													"text" : "sel 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 71.0, 199.0, 27.0, 17.0 ],
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 283.0, 79.0, 77.0, 17.0 ],
													"text" : "t b i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 71.0, 231.0, 35.0, 17.0 ],
													"text" : "gate 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 96.0, 44.0, 27.0, 17.0 ],
													"text" : "0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 283.0, 34.0, 34.0, 17.0 ],
													"text" : "ll.r flip"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 96.0, 347.0, 141.0, 15.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 365.0, 243.0, 64.0, 15.0 ],
													"text" : "1 1 0, 1 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 350.0, 224.0, 64.0, 15.0 ],
													"text" : "1 0 0, 1 1 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 71.0, 369.0, 138.0, 15.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 96.0, 21.0, 50.0, 17.0 ],
													"text" : "ll.r source"
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 249.0, 256.0, 81.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 134.0, 288.0, 40.0, 20.0 ],
													"text" : "zl reg"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 72.0, 53.0, 36.0, 20.0 ],
													"text" : "sel 0"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 41.0, 346.0, 15.0, 15.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 198.0, 230.0, 37.0, 20.0 ],
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
													"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
													"triscale" : 0.9
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 160.0, 71.0, 37.0, 20.0 ],
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
													"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
													"triscale" : 0.9
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 134.0, 507.0, 84.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 72.0, 24.0, 50.0, 20.0 ],
													"text" : "ll.r shift"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 137.0, 131.0, 35.0, 20.0 ],
													"text" : "* -1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 165.0, 260.0, 42.0, 20.0 ],
													"text" : "+ 256"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 140.0, 232.0, 44.0, 20.0 ],
													"text" : "gate 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 164.0, 197.0, 34.0, 20.0 ],
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 137.0, 153.0, 46.0, 20.0 ],
													"text" : "t i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 164.0, 176.0, 34.0, 20.0 ],
													"text" : "< 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 134.0, 394.0, 44.0, 20.0 ],
													"text" : "del 10"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 87.0, 85.0, 69.0, 20.0 ],
													"text" : "t 1 b 2 i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 95.0, 316.0, 58.0, 20.0 ],
													"text" : "gate 2 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 134.0, 369.0, 33.0, 20.0 ],
													"text" : "t b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 134.0, 444.0, 43.0, 20.0 ],
													"text" : "zl join"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 134.0, 416.0, 42.0, 20.0 ],
													"text" : "zl reg"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 134.0, 348.0, 50.0, 20.0 ],
													"text" : "zl slice"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 2,
													"numoutlets" : 0,
													"patching_rect" : [ 42.0, 380.0, 79.0, 20.0 ],
													"text" : "ll.s spectFun"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 115.0, 154.0, 25.0, 25.0 ],
									"varname" : "in1[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 147.0, 320.0, 25.0, 25.0 ],
									"varname" : "out1[1]"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -1.0, 26.0, 254.0, 127.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 184.0, 17.0, 19.0 ],
					"text" : "-5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 184.0, 17.0, 19.0 ],
					"text" : "-1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 623.0, 176.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"boost" : [ 0.519161063026239 ],
						"boost-slider" : [ 21.649425506591825 ],
						"fade-on/off" : [ 0 ],
						"flip" : [ 0 ],
						"master" : [ 0 ],
						"mode!" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 738.0, 152.0, 100.0, 22.0 ],
					"restore" : [ "ext(1)", "in(2)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
