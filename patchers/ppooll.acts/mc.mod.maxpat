...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 328.0, 407.0, 85.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"restore" : [ "inputs~(6)", "mctrigger(6)", "delay(6)", "phase(6)", "max(6)", "min(6)", "fold(6)", "chance(6)", "jitter(6)", "shape(6)", "tilt(6)", "freq(6)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
