...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "delay 14400000 @interp spline @feedback 0",
														"patching_rect" : [ 371.0, 812.0, 248.0, 22.0 ],
														"numinlets" : 2,
														"numoutlets" : 1,
														"outlettype" : [ "" ],
														"id" : "obj-32"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 502.0, 228.0, 199.0, 22.0 ],
					"restore" : [ "freq(1)", "mctrigger(1)", "inputs~(1)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
