...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 311.0, 409.0, 68.0, 20.0 ],
									"text" : "r #0buffer"
								}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-73",
					"items" : [ "no", ",", "buffer_host1", ",", "ho_st1", ",", "modul.ator1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-136",
					"ignoreclick" : 1,
					"items" : [ "-", ",", "basic_pars", ",", "basic_pars.json", ",", "presets", ",", "presets.json", ",", "square", ",", "square.json", ",", "stupid", ",", "stupid.json", ",", "-", ",", "ƒ", "default.json", ",", "ƒ", "most.json", ",", "ƒ", "square.json" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
