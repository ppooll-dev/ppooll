...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 153.0, 225.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 262.0, 46.0, 56.0, 22.0 ],
					"text" : "autopattr",
					"varname" : "u859019538"
				}
...
, 			{
				"box" : 				{
					"active" : 					{
						"act::actmaker_sub::active_store" : 0
					}
,
					"id" : "obj-5",
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 159.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 158.0, 60.0, 23.0 ],
					"text" : "inx front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 200.0, 92.0, 22.0 ],
					"text" : "pattrforward act"
				}
...
,
					"patching_rect" : [ 171.0, 14.0, 37.0, 22.0 ],
					"text" : "p title"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 145.0, 13.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 217.0, 14.0, 67.0, 22.0 ],
