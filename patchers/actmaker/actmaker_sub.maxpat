...
,
		"classnamespace" : "box",
		"rect" : [ 923.0, 404.0, 603.0, 382.0 ],
		"gridsize" : [ 15.0, 15.0 ],
		"globalpatchername" : "2262m",
		"boxes" : [ 			{
				"box" : 				{
					"id" : "obj-6",
					"maxclass" : "message",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 88.0, 172.0, 21.0 ],
					"text" : "pattrmarker #0m @invisible 1",
					"varname" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 88.0, 21.0, 22.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 110.0, 324.0, 79.0, 22.0 ],
																	"saved_object_attributes" : 																	{
																		"parameter_enable" : 0
																	}
,
																	"text" : "v8 ll.allacts.js",
																	"textfile" : 																	{
																		"filename" : "ll.allacts.js",
																		"flags" : 0,
																		"embed" : 0,
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 176.0, 218.0, 89.0, 22.0 ],
																	"text" : "r #0actname"
																}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 273.0, 52.0, 50.0, 22.0 ],
									"text" : "bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 316.0, 165.0, 177.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 231.0, 116.0, 219.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "bang" ],
									"patching_rect" : [ 175.0, 46.0, 32.0, 22.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 175.0, 80.0, 261.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 175.0, 217.0, 73.0, 22.0 ],
									"text" : "pattrforward"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 175.0, 185.0, 79.0, 22.0 ],
									"text" : "r #0pat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.0, 147.0, 73.0, 22.0 ],
									"text" : "pattrforward"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.0, 65.0, 71.0, 22.0 ],
									"text" : "r #0TP"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.0, 91.0, 51.0, 22.0 ],
									"text" : "r ll_TPs"
								}
...
,
					"patching_rect" : [ 9.0, 301.0, 36.0, 22.0 ],
					"text" : "p TP"
				}
...
,
					"patching_rect" : [ 50.0, 301.0, 68.0, 22.0 ],
					"text" : "p freebang"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 46.0, 98.0, 206.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 159.0, 40.0, 70.0, 22.0 ],
									"text" : "loadmess 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 159.0, 70.0, 40.0, 22.0 ],
									"text" : "itoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 433.0, 139.0, 24.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 404.0, 13.0, 123.0, 22.0 ],
									"text" : "r #0actname"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 404.0, 111.0, 48.0, 22.0 ],
									"text" : "route 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 223.0, 410.0, 81.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 433.0, 182.0, 99.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 333.166666666666686, 421.0, 15.0, 15.0 ]
								}
