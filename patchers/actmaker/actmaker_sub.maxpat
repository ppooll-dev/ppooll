...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 89.700000000000003, 289.0, 153.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 78.200000000000003, 166.0, 42.0, 22.0 ],
													"text" : "t b b b"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 37.5, 145.0, 44.0, 20.0 ],
																	"text" : "ll.allacts"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 171.5, 225.0, 69.0, 29.0 ],
																	"text" : ";\r$1 TP dispose"
																}
...
, 															{
																"box" : 																{
																	...
																	"outlettype" : [ "bang" ],
																	"parameter_enable" : 0,
																	"patching_rect" : [ 38.5, 126.0, 15.0, 15.0 ]
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 62.5, 225.0, 82.0, 29.0 ],
																	"text" : ";\rho_st1 TP clean"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 62.5, 180.0, 128.0, 19.0 ],
																	"text" : "route ho_st1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "bang" ],
																	"patching_rect" : [ 38.5, 94.0, 15.0, 15.0 ]
																}
...
,
													"patching_rect" : [ 256.0, 232.0, 63.0, 22.0 ],
													"saved_object_attributes" : 													{
														"fontsize" : 10.0
													}
,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 114.699999999999989, 232.0, 103.0, 35.0 ],
													"text" : ";\r#0TP dispose"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 33.0, 91.0, 22.0, 22.0 ],
													"text" : "t 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 33.0, 60.0, 63.0, 22.0 ],
													"text" : "sel ho_st1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 78.0, 129.0, 53.199999999999989, 22.0 ],
													"text" : "gate 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 33.0, 30.0, 75.0, 49.0 ],
													"text" : "r #0actname"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 112.199999999999989, 30.0, 30.0, 30.0 ]
												}
...
,
									"patching_rect" : [ 452.889999999999986, 371.350000000000023, 47.0, 22.0 ],
									"text" : "p close"
								}
