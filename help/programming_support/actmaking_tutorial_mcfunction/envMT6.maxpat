...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 166.0, 512.0, 160.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "- trigger 0 is not working as expected, so we need a workaround:\n- [sel 0] to the [ll.r trigger]\n- and a [uzi 4] will do\n- we want to send the signal to other acts\n- put a ll.blues into the main patcher:\n  eg. open the act fmrm and copy-paste ll.blues from there\n  note that ll.blues has scripting_name \"ll.blues\" !"
				}
