...
, 			{
				"box" : 				{
					...
					"text" : "- lets use the channels of ll.blues to set the channels in our patch:\n- in the subpatch create a [ll.r llbluechans] which will receive the chans from ll.blues\n- connect this object to ll.pf function and mc.line~\n- the trigger also needs to get resized, \n   i decide to put the channel-handling into a subpatch..\n- select ll.r llbluechans and \"tabs to ll.pf trigger\" and do a \"encapsulate\" (shift command e)\n"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 505.0, 200.0, 70.0, 22.0 ],
									"text" : "chans 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 469.0, 47.0, 70.0, 22.0 ],
									"text" : "chans 6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 386.5, 12.0, 85.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 317.0, 102.0, 81.0, 22.0 ],
									"text" : "tabs 0 1 2 3 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 317.0, 131.0, 65.0, 22.0 ],
									"text" : "ll.pf trigger"
								}
