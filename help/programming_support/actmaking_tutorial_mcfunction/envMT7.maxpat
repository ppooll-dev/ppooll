...
, 			{
				"box" : 				{
					...
					"text" : "- we want ll.blues in mc-mode here\n (we don't need volume or mix here)\n- see ll.blues.help for insights\n- open the inspector of ll.blues and edit args(Arguments)\n  write @status 3 0 0 0 0 1 1 \n  (3== mc.mode with displayed out-channels, the 1 at position 6 will link input-output channels)\n  also make it a bit higher with @rowhight 17\n- in the subpatch create a [ll.pf ll.blues]\nnow our patch should \"play\" to ho_st."
				}
