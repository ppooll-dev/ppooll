...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 150.0, 575.0, 160.0, 17.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 98.0, 120.0, 20.0 ],
					"rounded" : 4.0,
					"tabs" : [ "0", "1", "2", "3", "4", "5" ],
					"varname" : "trigger"
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 312.0, 387.0, 109.0, 22.0 ],
													"text" : "tabs 0 1 2 3 4 5"
												}
