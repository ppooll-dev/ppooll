...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 20.0, 577.0, 114.0 ],
					"text" : "- actmake created itself as the title_menu\n- actmake created some additional objects:\n   - pattrstorage * which holds all parameters and optional presets (scriptingname: pat)\n     (the first outlet of pattrstorage is connected to a pattrforward that sends into our actmake)\n   - thispatcher * used by actmake (scriptingname: thispatcher) \n   - pattrmarker * a useful object to address this patch (scriptingname: pattrmarker) \n   - autopattr * which will expose all Uis with scriptingnames to pattrstorage (scriptingname: autopattr) \n   - a subpatch, that will hold all our code and can be opened by the title_menu"
				}
