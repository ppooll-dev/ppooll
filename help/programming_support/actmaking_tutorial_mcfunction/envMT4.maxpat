...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 20.0, 577.0, 141.0 ],
					"text" : "- in the subpatcher create a [ll.r trigger] object\n- create a message object and connect its second inlet to [ll.r trigger] first outlet\n- click on the trigger in this (main) patcher and watch what comes out of [ll.r trigger] in the subpatch\n- you see that we receive the index starting with 0 here, which is fine, because we want the 0 to \n  also trigger all functions.\n- we only have to redefine \"tabs\" with a message to our trigger-object:\n  send a message \"tabs 0 1 2 3 4\" to a [ll.pf trigger] in the subpatch\n  (we will need this later for changing the channel-count as well)\n  (ll.r xy and ll.pf xy could be combined as a single ll.p xy, but i keep it seperated here..)\n"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.0, 113.0, 107.0, 22.0 ],
									"text" : "4"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 333.0, 180.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 289.0, 286.0, 164.0, 94.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 289.0, 245.0, 120.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 289.0, 217.0, 63.0, 22.0 ],
									"text" : "mc.target"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 385.0, 180.0, 110.0, 21.0 ],
									"text" : "channel number"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 79.0, 166.0, 65.0, 22.0 ],
									"text" : "lineout $1"
								}
