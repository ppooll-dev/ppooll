{
	"patcher" : 	{
		...
		"enablehscroll" : 1,
		"enablevscroll" : 1,
		"globalpatchername" : "ll.getp.maxhelp1",
		"boxes" : [ 			{
				"box" : 				{
					"fontname" : "Arial",
					"fontsize" : 12.0,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 327.0, 36.0, 18.0 ],
					"text" : "multi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 405.0, 232.0, 18.0 ],
					"text" : "multi 29 18 13 69 62 69 47 38 25 22"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 322.0, 39.0, 18.0 ],
					"text" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 354.0, 43.0, 20.0 ],
					"text" : "ll.getp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 63.0, 144.0, 20.0 ],
					"text" : "actmaker ll.getp.maxhelp",
					"varname" : "act"
				}
