{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 234.0, 516.0, 151.0, 22.0 ],
                    "text": "fullpath ::ho_st1::vol_slider"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 12.0, 547.0, 72.0, 35.0 ],
                    "text": "doesnotexist"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 119.0, 474.0, 45.0, 22.0 ],
                    "text": "ho_st1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 65.0, 504.0, 73.0, 22.0 ],
                    "text": "ll.pp inputs~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 140.5, 362.5, 39.0, 22.0 ],
                    "text": "slider"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 104.5, 362.5, 34.0, 22.0 ],
                    "text": "num"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 266.0, 305.0, 100.0, 22.0 ],
                    "pattrmode": 1,
                    "varname": "men"
                }
            },
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 2,
                    "numoutlets": 0,
                    "patching_rect": [ 445.5, 560.5, 65.0, 22.0 ],
                    "text": "ll.autohelp"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 428.5, 561.0, 72.0, 22.0 ],
                    "prefix_mode": 2,
                    "showdotfiles": 1
                }
            },
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 40.0, 392.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 89.0, 393.0, 65.0, 22.0 ],
                    "text": "ll.pp slider",
                    "varname": "ll.pp"
                }
            },
        ...
        "autosave": 0,
        "bgcolor": [ 0.2784313725490196, 0.09803921568627451, 0.09803921568627451, 1.0 ]
    }
}