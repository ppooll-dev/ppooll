{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 348.0, 130.0, 83.0, 22.0 ],
                    "text": "loadmess 180"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 363.0, 496.0, 28.0, 20.0 ],
                    "text": "etc."
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 332.0, 467.0, 20.0, 20.0 ],
                    "rounded": 60.0,
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 224.0, 478.0, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "saved_attribute_attributes": {
                        "bgcolor": {
                            "expression": "themecolor.lesson_step_circle"
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 164.0, 484.0, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "saved_attribute_attributes": {
                        "bgcolor": {
                            "expression": "themecolor.lesson_step_circle"
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 354.0, 477.0, 91.0, 22.0 ],
                    "text": "symbol myins.4"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 354.0, 454.0, 91.0, 22.0 ],
                    "text": "symbol myins.1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 213.0, 454.0, 102.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 240.0, 318.0, 91.0, 20.0 ],
                    "text": "open sub-patch"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 19.0, 81.0, 402.0, 20.0 ],
                    "text": "ll.s~ can be used in any patch (the patch does not need to be a ppooll-act)"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 40.5, 349.0, 177.0, 33.0 ],
                    "text": "scripting names of these menus are \"acts\" and \"chan\""
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 442.0, 340.0, 69.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 442.0, 295.0, 100.0, 22.0 ],
                    "text": "pattrmarker no",
                    "varname": "pattrmarker"
                }
            },
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 95.0, 137.0, 124.0, 20.0 ],
                    "text": "send signals via ll.s~:"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "fontsize": 12.0,
                    "id": "obj-35",
                    "items": [ "no", ",", "ho_st1", ",", "sendstest1", ",", "ll.s~.maxhelp1" ],
                    "maxclass": "umenu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 116.0, 162.0, 76.0, 22.0 ],
                    "pattrmode": 1,
                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 194.33333333333334, 222.0, 101.0, 22.0 ],
                    "text": "ho_st1~out"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 24.0, 246.0, 310.0, 74.0 ],
                    "text": "arguments:\noptionally it takes the scripting names of the two menus as arguments, which will avoid patchcords.\nand ll.s~ can be used somewhere deep in your subpatches."
                }
            },
            {
                "box": {
                    ...
                    "fontsize": 12.0,
                    "id": "obj-10",
                    "items": [ "-no-", ",", "out.0", ",", "out.1", ",", "out.2", ",", "out.3", ",", "out.4", ",", "out.5", ",", "out.6", ",", "out.7", ",", "out.8" ],
                    "maxclass": "umenu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "int", "", "" ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 4,
                                    "outlettype": [ "", "", "", "" ],
                                    "patching_rect": [ 39.0, 169.0, 85.0, 22.0 ],
                                    "text": "ll.s~ acts chan"
                                }
                            },
                            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 131.16666666666669, 223.0, 182.0, 223.0, 182.0, 158.0, 206.5, 158.0 ],
                    "source": [ "obj-37", 1 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 58.5, 222.0, 112.0, 222.0, 112.0, 158.0, 125.5, 158.0 ],
                    "source": [ "obj-37", 0 ]
                }
            },
            {
        ...
        "autosave": 0,
        "bgcolor": [ 0.1607843137254902, 0.27450980392156865, 0.21568627450980393, 1.0 ]
    }
}