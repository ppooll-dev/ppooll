{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 100.0, 100.0, 692.0, 322.0 ],
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "jit.videoplanesP",
                        "description": "mix and position video (list-version)",
                        "tags": [ "jitter (images)" ],
                        "authors": [ "filip" ]
                    },
                    "hidden": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 57.0, 75.0, 51.0, 33.0 ],
                    "text": "frame interval "
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 108.0, 75.0, 63.0, 33.0 ],
                    "text": "framerate \ndisplay"
                }
            },
            {
