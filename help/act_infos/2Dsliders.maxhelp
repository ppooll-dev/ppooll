{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 827.0, 100.0, 852.0, 946.0 ],
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "2Dsliders",
                        "description": [ "control parameters by dragging points" ],
                        "authors": [ "filip" ],
                        "emails": [ "klaus@klingt.org" ],
                    ...
                    "patching_rect": [ 440.0, 21.0, 61.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 0,
                    "numoutlets": 0,
                    "patching_rect": [ 325.0, 21.0, 102.0, 22.0 ],
