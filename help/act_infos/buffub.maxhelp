{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 100.0, 87.0, 534.0, 796.0 ],
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "buffub",
                        "description": "records into buffers",
                        "tags": [ "audio input", "uses buffer_host", "recording", "multichannel (mc)" ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 84.5, 648.0, 406.0, 37.0 ],
