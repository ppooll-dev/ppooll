{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 134.0, 159.0, 712.0, 750.0 ],
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "flop",
                        "description": "sample looper",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 470.0, 984.0, 224.0, 27.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 21.0, 144.0, 79.0, 22.0 ],
                    "text": "loadmess 25"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 445.0, 1012.0, 166.0, 27.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 469.0, 700.0, 63.0, 20.0 ],
                    "pattrmode": 1,
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 79.0, 623.0, 60.0, 22.0 ],
                    "pattrmode": 1,
                    "textcolor": [ 0.121569, 0.121569, 0.121569, 1.0 ],
                    "varname": "buffer"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 531.0, 700.0, 49.0, 20.0 ],
                    "textcolor": [ 0.121569, 0.121569, 0.121569, 1.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 311.0, 1087.0, 110.0, 29.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 198.0, 1090.0, 102.0, 19.0 ],
                    "textcolor": [ 0.054902, 0.0, 0.972549, 1.0 ]
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 532.0, 658.0, 116.0, 37.0 ],
