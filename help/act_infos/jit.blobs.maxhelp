        ...
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "jit.blobs",
                        "description": "outputs a list with blobs tracked in an image",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 46.0, 212.0, 464.0, 20.0 ],
                    "text": "klaus@klingt.org, if you are interested..."
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 46.0, 153.0, 464.0, 47.0 ],
                    "text": "open  a control@, select ppooll as device and then select jit.blobs# as incomming port\nin the routing window you might select \"list_in\" to send the generated list to some parameter..."
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "text": "sends a list of blobs of the incoming image."
                }
            },
            {
                "box": {
