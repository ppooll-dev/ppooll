{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 134.0, 158.0, 861.0, 888.0 ],
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "banger",
                        "description": "send synchronized bangs",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 299.0, 186.0, 102.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 521.0, 237.0, 160.0, 29.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 454.0, 116.0, 113.0, 29.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 316.0, 116.0, 102.0, 19.0 ],
                    "textcolor": [ 0.054902, 0.0, 0.972549, 1.0 ]
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 139.0, 27.0, 61.0, 19.0 ],
