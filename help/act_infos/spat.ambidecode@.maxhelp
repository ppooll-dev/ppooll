        ...
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "spat.ambidecode@",
                        "description": "ambisonics b-format decoder",
                        "tags": [ "plugin", "signal router", "audio converter", "multichannel (mc)" ],
                        "authors": [ "c. hausch" ]
                    },
                    "hidden": 1,
                    "id": "obj-9",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 369.0, 679.0, 106.69903355836868, 18.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 286.0, 682.0, 37.113281, 13.0 ],
                    "text": "write",
                    "texton": "write",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 248.0, 682.0, 36.014648, 13.0 ],
                    "text": "read",
                    "texton": "read",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 325.0, 682.0, 42.009766, 13.0 ],
                    "text": "clear",
                    "texton": "clear",
                    "varname": "clear"
                }
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 203.0, 422.0, 36.014648, 13.0 ],
                    "text": "delays",
                    "texton": "delays",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 40.0, 420.0, 160.985352, 14.5 ],
                    "sliderlog": 8.0,
                    "slidermax": 100.0,
                    "slidermin": 0.01,
                    "varname": "scale"
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 141.0, 155.0, 214.0, 66.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 470.0, 213.0, 37.113281, 13.0 ],
                    "text": "config",
                    "texton": "config",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 431.0, 213.0, 37.113281, 13.0 ],
                    "text": "write",
                    "texton": "write",
                    "varname": "writeconfig"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 393.0, 213.0, 36.014648, 13.0 ],
                    "text": "read",
                    "texton": "read",
                    "varname": "readconfig"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 343.0, 242.0, 163.49121000000002, 13.0 ],
                    "varname": "ll.blues",
                    "viewvisibility": 1
                }
            },
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 392.0, 227.0, 114.49121, 13.0 ],
                    "slidercolor": [ 0.784314, 0.145098, 0.023529, 1.0 ],
                    "sliderlog": 8.0,
                    "slidermax": 64.0,
                    "sliderstyle": 0,
