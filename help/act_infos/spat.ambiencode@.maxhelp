        ...
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "spat.ambiencode@",
                        "description": "ambisonics b-format encoder",
            ...
            },
            {
                "box": {
                    "embedstate": [
                        [ "savedState", 1, 3, 1.5, 1, 0.444444, 0.33, 18, 100, 1, 1, 5.407744107744099, 36 ]
                    ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 268.5, 154.0, 37.113281, 13.0 ],
                    "text": "mixer",
                    "texton": "mixer",
                    "varname": "mixerWindow"
                }
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 229.5, 154.0, 37.113281, 13.0 ],
                    "text": "config",
                    "texton": "config",
