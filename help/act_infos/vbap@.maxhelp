{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    "data": {
                        "act": "vbap@",
                        "description": "multi-speaker-spat or plugin-router",
                        "tags": [ "plugin", "signal router", "multichannel (mc)" ],
                        "authors": [ "filip" ]
                    },
                    "hidden": 1,
                    "id": "obj-19",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 65.0, 1077.0, 392.0, 33.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 129.5, 1042.0, 392.0, 33.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 105.0, 1052.0, 20.0, 20.0 ],
                    "text": "1",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 18.0, 932.0, 534.0, 60.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 84.0, 909.0, 35.0, 20.0 ],
                    "textcolor": [ 0.0, 0.0, 0.0, 1.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 52.0, 909.0, 35.0, 20.0 ],
                    "textcolor": [ 0.0, 0.0, 0.0, 1.0 ],
                    "tricolor": [ 0.75, 0.75, 0.75, 1.0 ],
                    "varname": "walk_min"
                }
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 19.0, 909.0, 35.0, 20.0 ],
                    "textcolor": [ 0.0, 0.0, 0.0, 1.0 ],
                    "tricolor": [ 0.75, 0.75, 0.75, 1.0 ],
                    "varname": "walk_amount"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 55.0, 893.0, 50.0, 20.0 ],
                    "textcolor": [ 0.0, 0.0, 0.0, 1.0 ],
                    "tricolor": [ 0.75, 0.75, 0.75, 1.0 ],
                    "varname": "walk_time"
                }
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 525.0, 243.0, 60.0, 19.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 7.0, 720.0, 619.0, 114.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 80.0, 327.0, 21.0, 19.0 ],
                    "pattrmode": 1,
                    "prefix": "0",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 18.0, 220.0, 484.0, 33.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 24.0, 90.0, 27.0, 19.0 ],
                    "textcolor": [ 0.0, 0.0, 0.0, 1.0 ],
                    "tricolor": [ 0.75, 0.75, 0.75, 1.0 ],
                    "triscale": 0.9,
                    "varname": "inputs"
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 49.0, 90.0, 27.0, 19.0 ],
                    "textcolor": [ 0.0, 0.0, 0.0, 1.0 ],
                    "tricolor": [ 0.75, 0.75, 0.75, 1.0 ],
                    "triscale": 0.9
                }
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 4,
                    "numoutlets": 0,
                    "patching_rect": [ 503.0, 79.0, 93.0, 19.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 373.0, 673.0, 160.0, 29.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 188.0, 680.0, 38.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 18.0, 4.0, 55.0, 22.0 ],
                    "text": "vbap@"
                }
            },
            {
        ...
        "autosave": 0,
        "bgcolor": [ 0.9019607843137255, 0.5764705882352941, 0.38823529411764707, 1.0 ]
    }
}